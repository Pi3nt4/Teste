...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Se o botão "Finalizar" for clicado, muda o status
...
// Busca os dados do paciente para exibir no cabeçalho
// NOTA: O método readById() não existe no PacienteApiDao.php original. 
// Vamos usar a API diretamente para buscar os dados do paciente.
    ...
    <div class="container mt-5 mb-5">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="analise_urina.php?id=<?php echo $exame_id; ?>" method="post">
                    
                    <fieldset class="border p-3 mb-3">
                        <legend class="w-auto px-2 h5">1. Ágar CLED</legend>
                        <div class="row">
                            <div class="col-md-4 mb-3"><label class="form-label">Qtd. Colônias</label><input type="text" class="form-control" name="urina_agar_cled_qtd_colonias" value="<?php echo htmlspecialchars($dadosExame['urina_agar_cled_qtd_colonias'] ?? ''); ?>"></div>
                            <div class="col-md-4 mb-3"><label class="form-label">Lote</label><input type="text" class="form-control" name="urina_agar_cled_lote" value="<?php echo htmlspecialchars($dadosExame['urina_agar_cled_lote'] ?? ''); ?>"></div>
                            <div class="col-md-4 mb-3"><label class="form-label">Validade</label><input type="date" class="form-control" name="urina_agar_cled_validade" value="<?php echo htmlspecialchars($dadosExame['urina_agar_cled_validade'] ?? ''); ?>"></div>
                        </div>
                    </fieldset>
